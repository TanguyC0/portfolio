...
<html lang="fr">
    ...
    <body>
        <nav>
            <ul>
                <li><a href="./link.php?page=cv">CV</a></li>
                <li><a href="./link.php?page=listeProjet">Projet</a></li>
                <li><a href="./link.php?page=contact">Contact</a></li>
            </ul>
        </nav>
        
        <?php include '../modul/'.$page.'.html'; ?>
